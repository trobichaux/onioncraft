  ...
  return (
    <div>
      ...
      <section aria-labelledby="profit-heading">
        ...
        <p className="section-desc">
          Shows the most profitable items you can craft from your <strong>remaining</strong>{' '}
          materials (after reserving for goals). Click Refresh Prices to update TP data and
          recalculate.
        </p>
        <RefreshButton />
        <ProfitTable />
      ...
      <section aria-labelledby="shopping-heading">
        ...
        <p className="section-desc">
          Your saved crafting plan. Check off items as you complete them in-game. This list persists
          between visits and will be available to external plugins.
        </p>
        <ShoppingList />
      </section>
    </div>
